    ...
    >
      <div className="mx-auto max-w-3xl">
        <Reveal>
          ...
          <p className="mb-10 text-center text-foreground-muted sm:mb-12 sm:text-base">
        ...
        {sightings.length === 0 ? (
          ...
          <ul className="flex flex-col gap-12">
            {sightings.map((s) => (
              <li key={s.id}>
                <Reveal>
                  <article className="overflow-hidden rounded-3xl border border-surface-ring bg-surface shadow-xl shadow-black/5 ring-1 ring-surface-ring dark:shadow-none">
                    {s.video ? (
                      <div className="border-b border-surface-ring bg-neutral-950 px-4 pb-5 pt-5 sm:px-6 sm:pb-6 sm:pt-6">
                        <p className="mb-3 text-center text-[0.65rem] font-black uppercase tracking-[0.2em] text-brand-amber sm:text-xs">
                          Último avistamento em vídeo
                        </p>
                        <div className="relative mx-auto max-w-2xl overflow-hidden rounded-2xl ring-2 ring-brand-amber/80 ring-offset-2 ring-offset-neutral-950">
                          <video
                            src={s.video}
                    ...
                    <div className="flex flex-col gap-5 p-5 sm:p-7">
                      ...
                      <div className="min-w-0 space-y-4">
                        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-baseline sm:gap-x-3">
                          <span className="inline-flex w-fit rounded-full bg-background-subtle px-3 py-1 text-xs font-bold text-foreground-muted">
                            {s.date}
                          </span>
                        ...
                        <a
                          ...
                          className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl bg-brand-amber px-5 py-3.5 text-center text-sm font-black text-neutral-950 shadow-md transition-opacity hover:opacity-95 active:opacity-100 sm:w-auto sm:justify-start sm:px-6"
                        >
                          <svg
